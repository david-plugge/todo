...
Ein öffentliches Deployment ist nicht eingerichtet. Dafür müssen HTTPS, PocketBase-Rate-Limits insbesondere für `/api/oauth/`, Benutzerbereitstellung und Backup/Restore konfiguriert werden. Abgelaufene OAuth-Datensätze werden bisher nicht automatisch bereinigt.
